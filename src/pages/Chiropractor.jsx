...
export default function Chiropractor() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    setError(null);
    console.log('Chiropractor Form Submitted:', form);
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: `New Lead from Stay Calm (/chiropractor Page): ${form.name}`,
          from_name: 'Stay Calm Website',
          page_submitted: '/chiropractor Page Form',
  ...
  const trustElements = [
    { title: '24/7 Support', desc: 'Available around the clock to support your recovery resources.', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    { title: 'Fast Response', desc: 'Connecting you quickly with trusted local care providers.', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { title: 'Trusted Resources', desc: 'Access to vetted chiropractor and wellness facilities.', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' }
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 relative group">
                ...
                <div className="relative bg-navy-950 rounded-2xl overflow-hidden border border-gold-500/20 aspect-[4/3] sm:aspect-square lg:aspect-[4/5] shadow-2xl">
                  <img
                    src="/chiropractor_hero.png"
                    alt="Premium Chiropractic Care"
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <span className="text-xs uppercase tracking-wider text-gold-400 font-semibold mb-1 block">Wellness & Recovery</span>
                    <h4 className="text-xl font-serif font-bold text-white">Vetted Chiropractic Support</h4>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-navy-950 border border-navy-800/80 rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="mb-8">
                    <h3 className="font-serif text-3xl font-bold text-white mb-3">
                      Request Chiropractic Assistance
                    </h3>
                    <p className="text-navy-300 text-sm">
                      Fill out the form below. A Stay Calm representative will coordinate with vetted care facilities and contact you shortly.
                    </p>
                  </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input id="email" name="email" type="email" value={form.email} onChange={handleChange} className={inputClasses} placeholder="john@example.com" />
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        <textarea id="description" name="description" rows={4} value={form.description} onChange={handleChange} className={`${inputClasses} resize-none`} placeholder="How can we assist you with chiropractic care resources?" />
                      </div>
